...
from .views import signup,login,submit_form_medium, submit_form_basique, submit_form_prenium, buy_tickets, get_history,logout_view,get_user_info, create_checkout_session
urlpatterns = [
